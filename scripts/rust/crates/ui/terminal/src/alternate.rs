...
pub struct Alternate {
    terminal: Terminal<crate::Backend<Stdout>>,
    raw: RawMode,
    alternate: bool,
    mouse: bool,
}
...
impl Alternate {
    pub fn new(mouse: MouseCapture) -> io::Result<Self> {
        ...
        let mut terminal = match Terminal::new(crate::Backend::new(crate::SgrWriter::new(stdout))) {
    ...
    pub fn terminal(&mut self) -> &mut Terminal<crate::Backend<Stdout>> {
        &mut self.terminal
    }
}
