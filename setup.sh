...
RUST_BINARIES="agent-hop bench-workloads count doc-purge dotfile dotfile-format dotfmt flatten gget git-discard gpp hpull hpush hwire mux-route path size sysinfo-collect"
RUST_HASH="$(
